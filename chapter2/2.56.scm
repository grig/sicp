...
; Exercise 2.56: Show how to extend the basic differentiator to handle more kinds
...
; thing raised to the power 0 is 1 and anything raised to the power 1 is the thing
; itself.
