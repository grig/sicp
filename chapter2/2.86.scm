...
;will have to define operations such as sine and cosine that are generic over ordinary numbers and
;rational numbers.

;; We need to replace all arithmetic operations on components of complex number with their generic counterparts. That is, * becomes mul, + becomes add and sin becomes sine.
