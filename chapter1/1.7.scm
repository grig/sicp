...
; be very e\ufb00ective for \ufb01nding the square roots of very small numbers. Also, in
...
; in original program (sqrt (* 5 3000000000000)) never stops because however
; long we guess, error would be always greater than 0.001 due to rounding
; errors.
